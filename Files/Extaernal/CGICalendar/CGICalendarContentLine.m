...
- (void)setString:(NSString *)aString
{
	...
	NSArray *nameParams = [values[0] componentsSeparatedByString:CG_ICALENDAR_CONTENTLINE_NAMEPARAM_DELIM];
	NSMutableArray *params = [NSMutableArray array];
	int nameParamsCnt = [nameParams count];
	for (int n=0; n<nameParamsCnt; n++) {
		if (n == 0) {
			[self setName:nameParams[0]];
			continue;
		}
		CGICalendarParameter *icalParam = [[CGICalendarParameter alloc] initWithString:nameParams[n]];
