...
- (void)viewDidLoad
{
    ...
    AnimalsImagesScrollView *imagesScrollView = [[AnimalsImagesScrollView alloc] initWithFrame:CGRectMake(0, 20, 320, 190) withAnimal:self.animal];
    ...
    ConservasionStatusIndicator *consInd = [[ConservasionStatusIndicator alloc] initWithFrame:CGRectMake(0, 0, 320, 20)];
