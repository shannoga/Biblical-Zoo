...
- (void)layoutSubviews {
	...
	if ([[Helper currentLang] isEqualToString:@"en"]) {
        self.labelView.frame =         CGRectMake(10,3,CGRectGetWidth(self.frame)-10,CGRectGetHeight(self.frame)/4);
        ...
        self.labelView.frame =         CGRectMake(0,3,CGRectGetWidth(self.frame)-10,CGRectGetHeight(self.frame)/4);
